    ...
    return (
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="border-l-2 border-l-yellow-500 p-4 rounded">border-l-yellow-500</div>
         ...
         <div className="border-e-4 border-e-pink-500 p-4 rounded text-right">border-e-pink-500 (v3.3+)</div>
      </div>
    );
  };
...
const BorderXYColorExample: React.FC = () => {
    return (
      <div className="grid grid-cols-1 gap-4">
        <div className="border-x-4 border-x-cyan-500 border-y-2 border-y-transparent p-4 rounded">border-x-cyan-500</div> {/* y方向は透明に */}
        <div className="border-y-8 border-y-fuchsia-500 border-x-2 border-x-transparent p-4 rounded">border-y-fuchsia-500</div> {/* x方向は透明に */}
      </div>
    );
  };
    ...
    return (
      <div className="space-y-2">
         ...
         <div className="border-4 border-green-600 p-2 rounded">
            ...
            <div className="border-4 border-inherit mt-1 p-2">Border Inherit: Inherits green border color.</div>
         </div>
...
const ArbitraryBorderColorExample: React.FC = () => {
    return (
      <div className="border-4 border-[#ff7f50] p-4 rounded">
        任意の値: border-[#ff7f50] (Coral)
      </div>
    );
  };
      ...
      <div className="max-w-4xl mx-auto bg-stone-100 dark:bg-stone-800 rounded-lg shadow-md p-6 space-y-8">
        ...
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <p>
              要素の境界線 (border) の色を設定するためのユーティリティクラスです。すべての辺、特定の辺、または水平/垂直方向の辺の色を個別に制御できます。
            </p>
            <p>
              CSS の <code>border-color</code> およびその個別指定プロパティ (<code>border-top-color</code> など)、論理プロパティ (<code>border-inline-start-color</code> など) を制御します。
            </p>
          </CardContent>
        </Card>
        {/* 基本的な使い方とパラメータ Card */}
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <p>
              <code>border-&lbrace;side&rbrace;-&lbrace;color&rbrace;[-&lbrace;shade&rbrace;]</code> または <code>border-&lbrace;axis&rbrace;-&lbrace;color&rbrace;[-&lbrace;shade&rbrace;]</code>, <code>border-&lbrace;color&rbrace;[-&lbrace;shade&rbrace;]</code> の形式でクラスを要素に適用します。通常、<code>border</code> または <code>border-&lbrace;side/axis&rbrace;-&lbrace;width&rbrace;</code> と一緒に使用します。
            </p>
            <ul className="list-disc list-inside space-y-1 pl-4">
              <li><strong><code>border-{'{color}'}[-{'{shade}'}]</code></strong>: すべての辺に同じ色を設定します (例: <code>border-blue-500</code>)。</li>
              <li><strong><code>border-{'{side}'}-{'{color}'}[-{'{shade}'}]</code></strong>: 特定の辺の色を設定します。
                <ul>
              ...
              <li><strong><code>border-{'{axis}'}-{'{color}'}[-{'{shade}'}]</code></strong>: 水平または垂直方向の辺の色を設定します。
                <ul>
                  <li><code>x</code> (左右), <code>y</code> (上下)。</li>
                </ul>
                 例: <code>border-x-purple-500</code>, <code>border-y-pink-600</code>。
              </li>
               <li><strong>特殊な値</strong>: <code>border-inherit</code>, <code>border-current</code>, <code>border-transparent</code>, <code>border-black</code>, <code>border-white</code>。</li>
            </ul>
             <p className="mt-4">
              <code>{'{color}'}</code> と <code>{'{shade}'}</code> には、Tailwind のカラーパレットを使用します。
            </p>
             <p>
              任意の色 (例: <code>border-[#ff7f50]</code>) も使用可能です (Tailwind JIT モード)。
            </p>
             <p>
              Tailwind CSS v3.0 以降では、スラッシュ記法 (例: <code>border-blue-500/50</code>) を使用して透明度 (アルファ値) を指定できます。
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-stone-600 dark:text-stone-400">
              ブレークポイント (<code>md:border-red-500</code> など) や状態 (<code>hover:border-blue-600</code>, <code>dark:border-gray-600</code> など) に応じて境界線の色を変更できます。
            </CardDescription>
          </CardHeader>
          <CardContent>
...
<button class="border border-transparent hover:border-black ...">...</button>
        ...
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <ul className="list-disc list-inside space-y-1 pl-4">
              <li>
                境界線を表示するには、色 (<code>border-*</code>) に加えて、通常は太さ (<code>border</code>, <code>border-*</code>) とスタイル (<code>border-solid</code> など) も指定する必要があります。
              </li>
              <li>
                デフォルトでは、境界線の色は <code>border-gray-200</code> (ライトモード) または <code>border-gray-700</code> (ダークモード、設定による) が適用されることが多いですが、明示的に指定することが推奨されます。
              </li>
               <li>
        ...
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <ul className="list-disc list-inside space-y-1 pl-4">
              ...
              <li>
                <code>border-opacity</code> (<code>border-opacity-*</code>): 境界線の色の透明度を設定します (古い構文)。
              </li>
               <li>
                <code>divide-color</code> (<code>divide-*</code>): 子要素間の境界線の色を設定します。
              </li>
               <li>
