  ...
  return (
    <div className="relative h-48 w-full rounded-lg overflow-hidden">
      ...
      <div className="absolute inset-0 grid grid-cols-2 gap-px"> {/* gap-px で境界線を表現 */}
        <div className="backdrop-sepia bg-white/30 flex items-center justify-center p-2"><span className="text-black text-xs font-semibold">sepia</span></div>
        <div className="backdrop-sepia-0 bg-white/30 flex items-center justify-center p-2"><span className="text-black text-xs font-semibold">sepia-0 (Default)</span></div>
      </div>
    </div>
  );
};
    ...
    <div className="bg-stone-200 dark:bg-stone-900 min-h-screen p-4 md:p-8 font-serif">
      ...
      <div className="max-w-4xl mx-auto bg-stone-100 dark:bg-stone-800 rounded-lg shadow-md p-6 space-y-8">
        ...
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <p>
              <code>backdrop-sepia</code> または <code>backdrop-sepia-0</code> の形式でクラスを要素に適用します。要素には透明度のある背景色が必要です。
            </p>
            <ul className="list-disc list-inside space-y-1 pl-4">
              <li><strong><code>backdrop-sepia</code></strong>: 背景を完全にセピア調にします (<code>backdrop-filter: sepia(100%);</code>)。</li>
              <li><strong><code>backdrop-sepia-0</code></strong>: 背景にセピアフィルターを適用しません (<code>backdrop-filter: sepia(0%);</code>)。これがデフォルトの挙動です。</li>
            </ul>
             <p className="mt-4">
              任意の値 (例: <code>backdrop-sepia-[.65]</code>) も使用可能です (Tailwind JIT モード)。0 から 1 の間の数値を指定します (例: 0.65 は 65% セピア)。この場合、<code>backdrop-filter</code> ユーティリティも必要になることがあります。
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              <h3 className="font-semibold text-stone-700 dark:text-stone-300 mb-2">標準背景セピア</h3>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-stone-600 dark:text-stone-400">
              ブレークポイント (<code>md:backdrop-sepia</code> など) や状態 (<code>hover:backdrop-sepia-0</code> など) に応じて背景セピア効果を変更できます。
            </CardDescription>
          </CardHeader>
          <CardContent>
    ...
    Hover Me
        ...
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <ul className="list-disc list-inside space-y-1 pl-4">
               <li>
                <code>backdrop-filter</code>: 他の背景フィルターユーティリティを有効にするための基本クラス。<code>backdrop-sepia-*</code> は自動的にこれを有効にします。
              </li>
              <li>
                <code>filter</code> (<code>sepia</code> など): 要素自体とその内容にフィルターを適用します。
              </li>
              <li>
                他の背景フィルターユーティリティ: <code>backdrop-blur</code>, <code>backdrop-brightness</code>, <code>backdrop-contrast</code>, <code>backdrop-grayscale</code>, <code>backdrop-hue-rotate</code>, <code>backdrop-invert</code>, <code>backdrop-opacity</code>, <code>backdrop-saturate</code>。
              </li>
            </ul>
          </CardContent>
        </Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <ul className="list-disc list-inside space-y-1 pl-4">
              ...
              <li>
               ...
               <li>
                <a
                  href="https://developer.mozilla.org/en-US/docs/Web/CSS/filter-function/sepia"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sky-600 hover:text-sky-800 dark:text-sky-400 dark:hover:text-sky-300 underline"
                >
