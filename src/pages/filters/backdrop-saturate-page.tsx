  ...
  return (
    <div className="relative h-48 w-full rounded-lg overflow-hidden">
      ...
      <div className="absolute inset-0 grid grid-cols-2 md:grid-cols-4 gap-px"> {/* gap-px で境界線を表現 */}
        <div className="backdrop-saturate-0 bg-white/30 flex items-center justify-center p-2"><span className="text-black text-xs font-semibold">0</span></div>
        <div className="backdrop-saturate-50 bg-white/30 flex items-center justify-center p-2"><span className="text-black text-xs font-semibold">50</span></div>
        <div className="backdrop-saturate-100 bg-white/30 flex items-center justify-center p-2"><span className="text-black text-xs font-semibold">100 (Default)</span></div>
        <div className="backdrop-saturate-150 bg-white/30 flex items-center justify-center p-2"><span className="text-black text-xs font-semibold">150</span></div>
        <div className="backdrop-saturate-200 bg-white/30 flex items-center justify-center p-2"><span className="text-black text-xs font-semibold">200</span></div>
      </div>
    </div>
  );
};
    ...
    <div className="bg-stone-200 dark:bg-stone-900 min-h-screen p-4 md:p-8 font-serif">
      ...
      <div className="max-w-4xl mx-auto bg-stone-100 dark:bg-stone-800 rounded-lg shadow-md p-6 space-y-8">
        ...
        <h1 className="text-3xl font-bold text-center text-stone-900 dark:text-stone-100">
          Filters: Backdrop Saturate (背景の彩度)
        </h1>
        {/* 概要 Card */}
        <Card>
          <CardHeader>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <p>
              要素の背後にあるコンテンツに彩度 (saturation) フィルターを適用するためのユーティリティクラスです。背景の色の鮮やかさを調整します。
            </p>
            <p>
        ...
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <p>
              <code>backdrop-saturate-{'{amount}'}</code> の形式でクラスを要素に適用します。要素には透明度のある背景色が必要です。
            </p>
            <p><code>{'{amount}'}</code> には、0 から 200 までの数値 (通常は 50 刻み) を指定します。これはパーセンテージに対応します (例: <code>backdrop-saturate-150</code> は 150% の彩度)。</p>
            <ul className="list-disc list-inside space-y-1 pl-4">
              <li><strong><code>backdrop-saturate-0</code></strong> (0%)</li>
              <li><strong><code>backdrop-saturate-50</code></strong> (50%)</li>
              <li><strong><code>backdrop-saturate-100</code></strong> (100% - デフォルト、変化なし)</li>
              <li><strong><code>backdrop-saturate-150</code></strong> (150%)</li>
              <li><strong><code>backdrop-saturate-200</code></strong> (200%)</li>
            </ul>
             <p className="mt-4">
              任意の値 (例: <code>backdrop-saturate-[.85]</code>) も使用可能です (Tailwind JIT モード)。0 以上の数値を指定します (例: 0.85 は 85%)。この場合、<code>backdrop-filter</code> ユーティリティも必要になることがあります。
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              <h3 className="font-semibold text-stone-700 dark:text-stone-300 mb-2">標準の背景彩度</h3>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-stone-600 dark:text-stone-400">
              ブレークポイント (<code>md:backdrop-saturate-150</code> など) や状態 (<code>hover:backdrop-saturate-200</code> など) に応じて背景の彩度を変更できます。
            </CardDescription>
          </CardHeader>
          <CardContent>
    ...
    Hover Me
        ...
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <ul className="list-disc list-inside space-y-1 pl-4">
               <li>
                <code>backdrop-filter</code>: 他の背景フィルターユーティリティを有効にするための基本クラス。<code>backdrop-saturate-*</code> は自動的にこれを有効にします。
              </li>
              <li>
                <code>filter</code> (<code>saturate-*</code> など): 要素自体とその内容にフィルターを適用します。
              </li>
              <li>
                他の背景フィルターユーティリティ: <code>backdrop-blur</code>, <code>backdrop-brightness</code>, <code>backdrop-contrast</code>, <code>backdrop-grayscale</code>, <code>backdrop-hue-rotate</code>, <code>backdrop-invert</code>, <code>backdrop-opacity</code>, <code>backdrop-sepia</code>。
              </li>
            </ul>
          </CardContent>
        </Card>
