...
const ItemsStartExample: React.FC = () => {
  return (
    <div className="flex items-start bg-gray-100 dark:bg-gray-800 p-2 rounded h-24 space-x-2"> {/* h-24 で高さを指定 */}
...
const ItemsBaselineExample: React.FC = () => {
    return (
      <div className="flex items-baseline bg-gray-100 dark:bg-gray-800 p-2 rounded space-x-2">
        <div className="bg-red-300 dark:bg-red-700 pt-2 pb-6 rounded text-sm">Baseline 1</div> {/* padding で高さを変える */}
        <div className="bg-red-300 dark:bg-red-700 pt-8 pb-2 rounded text-lg">Baseline 2</div> {/* font-size も変える */}
...
const ItemsStretchExample: React.FC = () => {
    return (
      <div className="flex items-stretch bg-gray-100 dark:bg-gray-800 p-2 rounded h-24 space-x-2">
        ...
        <div className="bg-purple-300 dark:bg-purple-700 p-2 rounded">Item 2</div> {/* 高さ指定なし */}
    ...
    <div className="bg-stone-200 dark:bg-stone-900 min-h-screen p-4 md:p-8 font-serif">
      ...
      <div className="max-w-4xl mx-auto bg-stone-100 dark:bg-stone-800 rounded-lg shadow-md p-6 space-y-8">
        ...
        <h1 className="text-3xl font-bold text-center text-stone-900 dark:text-stone-100">
          Flexbox & Grid: Align Items (アイテムの交差軸揃え)
        </h1>
        {/* 概要 Card */}
        <Card>
          <CardHeader>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <p>
              フレックスコンテナまたはグリッドコンテナ内のアイテムを、交差軸 (cross axis) 方向 (通常は垂直方向) にどのように配置するかを一括で制御するためのユーティリティクラスです。
            </p>
            <p>
              CSS の <code>align-items</code> プロパティを制御します。
            </p>
            <p>
              <strong>注意:</strong> このプロパティは、アイテムが単一行/列にある場合に効果があります。複数行/列に折り返している場合は <code>align-content</code> が行/列全体の揃え方を制御します。
            </p>
          </CardContent>
        </Card>
        {/* 基本的な使い方とパラメータ Card */}
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <p>
              <code>items-{'{alignment}'}</code> の形式でクラスをフレックスコンテナまたはグリッドコンテナに適用します。
            </p>
            <ul className="list-disc list-inside space-y-1 pl-4">
              <li><strong><code>items-start</code></strong>: アイテムを交差軸の開始位置 (通常は上端) に揃えます。</li>
              <li><strong><code>items-end</code></strong>: アイテムを交差軸の終了位置 (通常は下端) に揃えます。</li>
              <li><strong><code>items-center</code></strong>: アイテムを交差軸の中央に揃えます。</li>
              <li><strong><code>items-baseline</code></strong>: アイテムのテキストのベースライン (文字の底が揃う線) を揃えます。</li>
              <li><strong><code>items-stretch</code></strong>: デフォルト。アイテムをコンテナの交差軸方向のサイズいっぱいに引き伸ばします (アイテムにサイズ指定がない場合)。</li>
            </ul>
             {/* Tailwind v3.3+ */}
             <p className="mt-4">
              書字方向に対応する <code>items-normal</code> (デフォルトの揃え方、通常 <code>stretch</code>) もあります (v3.3+)。
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div>
             ...
             {/* Center */}
             <div>
              <h3 className="font-semibold text-stone-700 dark:text-stone-300 mb-2">items-center</h3>
              <pre className="bg-stone-200 dark:bg-stone-700 p-2 rounded overflow-x-auto text-sm text-stone-800 dark:text-stone-200 mb-2">
             ...
             {/* Baseline */}
             <div>
              <h3 className="font-semibold text-stone-700 dark:text-stone-300 mb-2">items-baseline</h3>
              <pre className="bg-stone-200 dark:bg-stone-700 p-2 rounded overflow-x-auto text-sm text-stone-800 dark:text-stone-200 mb-2">
             ...
             {/* Stretch */}
             <div>
              <h3 className="font-semibold text-stone-700 dark:text-stone-300 mb-2">items-stretch (デフォルト)</h3>
              <pre className="bg-stone-200 dark:bg-stone-700 p-2 rounded overflow-x-auto text-sm text-stone-800 dark:text-stone-200 mb-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-stone-600 dark:text-stone-400">
              ブレークポイントプレフィックス (<code>sm:</code>, <code>md:</code> など) を使って、画面サイズに応じて交差軸の揃え方を変更できます。
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-stone-700 dark:text-stone-300 mb-4">
              例えば、<code>items-start md:items-center</code> はデフォルトで上揃え、中程度の画面サイズ以上で中央揃えにします。
            </p>
            {/* コード表示 */}
  ...
  {/* ... items */}
        ...
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <ul className="list-disc list-inside space-y-1 pl-4">
              <li>
                <code>align-items</code> はフレックスコンテナまたはグリッドコンテナに適用します。個々のアイテムの揃え方を変更したい場合は <code>align-self</code> を使用します。
              </li>
              <li>
                このプロパティは、アイテムが単一行/列にある場合に効果があります。複数行/列の場合は <code>align-content</code> が行/列全体の揃え方を制御します。
              </li>
               <li>
                効果を確認するには、コンテナに交差軸方向のサイズ (通常は高さ <code>h-*</code>) が必要になる場合があります (特に <code>items-stretch</code> 以外の場合)。
              </li>
               <li>
        ...
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <ul className="list-disc list-inside space-y-1 pl-4">
              ...
              <li>
                <code>align-self</code> (<code>self-*</code>): 個々のアイテムの交差軸方向の揃え方を制御します。<code>align-items</code> の設定を上書きします。
              </li>
              <li>
               ...
               <li>
                <code>place-items</code> (<code>place-items-*</code>): <code>align-items</code> と <code>justify-items</code> を一括で設定するショートハンドです (Grid のみ)。
              </li>
               <li>
                <code>height</code> (<code>h-*</code>): コンテナの高さを設定します。<code>align-items</code> の効果を確認するために必要になることがあります。
              </li>
            </ul>
          </CardContent>
        </Card>
