...
const JustifyItemsStretchExample: React.FC = () => {
    return (
      <div className="grid grid-cols-3 justify-items-stretch gap-4 bg-gray-100 dark:bg-gray-800 p-4 rounded">
        ...
        <div className="bg-red-300 dark:bg-red-700 p-2 rounded text-center">Item 2</div> {/* 幅が異なる */}
    ...
    <div className="bg-stone-200 dark:bg-stone-900 min-h-screen p-4 md:p-8 font-serif">
      ...
      <div className="max-w-4xl mx-auto bg-stone-100 dark:bg-stone-800 rounded-lg shadow-md p-6 space-y-8">
        ...
        <h1 className="text-3xl font-bold text-center text-stone-900 dark:text-stone-100">
          Flexbox & Grid: Justify Items (アイテムのインライン軸揃え - Grid)
        </h1>
        {/* 概要 Card */}
        <Card>
          <CardHeader>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <p>
              グリッドコンテナ内のすべてのグリッドアイテムを、それぞれのグリッドエリア内でインライン軸 (通常は水平方向) に沿ってどのように配置するかを一括で制御するためのユーティリティクラスです。
            </p>
            <p>
              CSS の <code>justify-items</code> プロパティを制御します。<strong>これは Grid レイアウト専用です。</strong> Flexbox には効果がありません (Flexbox では <code>justify-content</code> を使用します)。
            </p>
          </CardContent>
        </Card>
        {/* 基本的な使い方とパラメータ Card */}
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <p>
              <code>justify-items-{'{alignment}'}</code> の形式でクラスをグリッドコンテナに適用します。
            </p>
            <ul className="list-disc list-inside space-y-1 pl-4">
              <li><strong><code>justify-items-start</code></strong>: 各アイテムをそれぞれのグリッドエリアの開始位置 (通常は左端) に配置します。</li>
              <li><strong><code>justify-items-end</code></strong>: 各アイテムをそれぞれのグリッドエリアの終了位置 (通常は右端) に配置します。</li>
              <li><strong><code>justify-items-center</code></strong>: 各アイテムをそれぞれのグリッドエリアの中央に配置します。</li>
              <li><strong><code>justify-items-stretch</code></strong>: デフォルト。各アイテムをそれぞれのグリッドエリアの幅いっぱいに引き伸ばします。</li>
            </ul>
             {/* Tailwind v3.3+ */}
             <p className="mt-4">
              書字方向に対応する <code>justify-items-normal</code> (デフォルトの揃え方、通常 <code>stretch</code>), <code>justify-items-legacy</code> もあります (v3.3+)。
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            {/* Start */}
            <div>
              <h3 className="font-semibold text-stone-700 dark:text-stone-300 mb-2">justify-items-start</h3>
            ...
            {/* End */}
            <div>
              <h3 className="font-semibold text-stone-700 dark:text-stone-300 mb-2">justify-items-end</h3>
              <pre className="bg-stone-200 dark:bg-stone-700 p-2 rounded overflow-x-auto text-sm text-stone-800 dark:text-stone-200 mb-2">
             ...
             {/* Center */}
             <div>
              <h3 className="font-semibold text-stone-700 dark:text-stone-300 mb-2">justify-items-center</h3>
              <pre className="bg-stone-200 dark:bg-stone-700 p-2 rounded overflow-x-auto text-sm text-stone-800 dark:text-stone-200 mb-2">
             ...
             {/* Stretch */}
             <div>
              <h3 className="font-semibold text-stone-700 dark:text-stone-300 mb-2">justify-items-stretch (デフォルト)</h3>
              <pre className="bg-stone-200 dark:bg-stone-700 p-2 rounded overflow-x-auto text-sm text-stone-800 dark:text-stone-200 mb-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-stone-600 dark:text-stone-400">
              ブレークポイントプレフィックス (<code>sm:</code>, <code>md:</code> など) を使って、画面サイズに応じてインライン軸の揃え方を変更できます。
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-stone-700 dark:text-stone-300 mb-4">
              例えば、<code>justify-items-start md:justify-items-center</code> はデフォルトで左揃え、中程度の画面サイズ以上で中央揃えにします。
            </p>
            {/* コード表示 */}
  ...
  {/* ... items */}
        ...
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <ul className="list-disc list-inside space-y-1 pl-4">
              <li>
                <code>justify-items</code> はグリッドコンテナに適用します。個々のアイテムの揃え方を変更したい場合は <code>justify-self</code> を使用します。
              </li>
              <li>
                このプロパティは Grid レイアウト専用です。Flexbox レイアウトには効果がありません。
              </li>
               <li>
                <code>justify-items-stretch</code> (デフォルト) 以外の値を使用すると、アイテムは自身のコンテンツサイズに基づいて幅が決まります (グリッドエリア内で)。
              </li>
            </ul>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="text-stone-700 dark:text-stone-300 space-y-4">
            <ul className="list-disc list-inside space-y-1 pl-4">
              ...
              <li>
                <code>justify-self</code> (<code>justify-self-*</code>): 個々のグリッドアイテムのインライン軸方向の揃え方を制御します。<code>justify-items</code> の設定を上書きします。
              </li>
              <li>
                <code>align-items</code> (<code>items-*</code>): グリッドアイテムのブロック軸 (通常は垂直) 方向の揃え方を制御します。
              </li>
               <li>
                <code>place-items</code> (<code>place-items-*</code>): <code>align-items</code> と <code>justify-items</code> を一括で設定するショートハンドです。
              </li>
            </ul>
          </CardContent>
        </Card>
